...
import { createOnType } from "../../Database/Models/TransactionModal";
...
export default function TransactionCard({id, mode, title, category, description, fromAccountId, toAccountId, createOn, amount, onPress=()=>{}}: TransactionCardProps): React.JSX.Element {
