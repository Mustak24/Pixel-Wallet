...
export default function HaveNoTransaction({text="You don't have any transaction."}:{text?: string}): React.JSX.Element {
    ...
    return (
        <View style={[style.center, style.width100, {padding: 30, opacity: 0.6}]}>
            ...
            <TextTheme style={{color, fontWeight: '900', fontSize: 18, marginTop: 10, marginBottom: 4}}>No Transactions</TextTheme>
